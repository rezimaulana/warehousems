<div class="container-fluid">
    <div class="row">
        <div class="col-xs-12 col-sm-12">
            <h3><a class="btn btn-primary pull-right" style="margin-bottom: 20px" href="<?= base_url('items/create'); ?>">Create Entry</a></h3>
                    ...
                    <?php foreach($result as $res) {?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger btn-sm" onclick="return confirm('Delete entry?')" href="<?= base_url('items/delete/').$res['id'] ?>">Delete</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
